<h1 class="h3 mb-2 text-gray-800">Tes Tertulis</h1>
                ...
                <tbody>
                    <?php foreach ($pelamar as $p) { ?>
                        <tr style="<?php if ($p->status_lamaran == 'LANJUT') {
                            ...
                            <td style="vertical-align:middle;text-align:center;"><?= $p->nilai4 ?></td>
                            <td style="vertical-align:middle;text-align:center;">
                                <div class="btn-group"><a class="btn btn-danger" href="<?= base_url('admin/seleksi_4/remove/') . $p->id ?>"><i class="fa fa-lg fa-times"></i></a></div>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('admin/seleksi_4/input'); ?>">
...
<div class="modal fade" id="Umumkan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a class="btn btn-primary" href="<?= base_url('admin/seleksi_4/umumkan'); ?>">Umumkan</a>
            </div>
        </div>
    </div>
</div>